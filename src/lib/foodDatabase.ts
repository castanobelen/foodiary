...
export const FOOD_DATABASE: Food[] = [
  ...
  { id: "db-patamuslo-pollo", name: "Pata muslo de pollo", methods: CARNE, calories: 205, protein: 24, carbs: 0, fat: 12 },
  { id: "db-pata-pollo", name: "Pata de pollo (jamoncito)", methods: CARNE, calories: 185, protein: 27, carbs: 0, fat: 8 },
  ...
  { id: "db-calabacin-crudo", name: "Calabacín / zucchini / zapallito", cooking: "crudo", calories: 17, protein: 1.2, carbs: 3.1, fat: 0.3 },
  { id: "db-calabacin-plancha", name: "Calabacín / zucchini / zapallito", cooking: "plancha", calories: 20, protein: 1.4, carbs: 3.5, fat: 0.4 },
  ...
  { id: "db-mandioca-crudo", name: "Mandioca / yuca", cooking: "crudo", calories: 160, protein: 1.4, carbs: 38, fat: 0.3 },
  { id: "db-mandioca-cocido", name: "Mandioca / yuca", cooking: "cocido", calories: 130, protein: 1.2, carbs: 31, fat: 0.2 },
  { id: "db-mandioca-frita", name: "Mandioca frita", cooking: "frito", calories: 265, protein: 1.8, carbs: 40, fat: 10 },
